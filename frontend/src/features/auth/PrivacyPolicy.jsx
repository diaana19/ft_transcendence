export default function PrivacyPolicy() {
  return (
    <div className="w-full mx-auto px-6 py-8 bg-transparent">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-1" style={{ color: '#2c2c2a' }}>Privacy Policy</h1>
...
www.cnil.fr`
        ...
        <div key={section.title} className="mb-6 rounded-xl px-4 py-4"
          ...
          <div className="text-sm font-semibold mb-3" style={{ color: '#185fa5' }}>{section.title}</div>
