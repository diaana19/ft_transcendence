export default function TermsOfService() {
  return (
    <div className="w-full mx-auto px-6 py-8 bg-transparent">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-1" style={{ color: '#2c2c2a' }}>Terms of Service</h1>
        <p className="text-sm" style={{ color: '#b4b2a9' }}>Effective date: June 1, 2026 · Last revised: June 1, 2026</p>
      </div>
...
For requests related to your personal data, including data access, correction, or deletion, please use the GDPR tools available in your account settings or contact us directly as described in our Privacy Policy.`
        ...
        <div key={section.title} className="mb-6 rounded-xl px-4 py-4"
          style={{ background: 'white', border: '0.5px solid #ede8fd' }}>
          <div className="text-sm font-semibold mb-3" style={{ color: '#534ab7' }}>{section.title}</div>
          <div className="text-xs leading-relaxed whitespace-pre-line" style={{ color: '#5f5e5a' }}>{section.text}</div>
        </div>
      ))}
    </div>
  )
