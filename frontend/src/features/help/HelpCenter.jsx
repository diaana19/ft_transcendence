...
const sections = [
  {
    ...
    title: "My account",
    icon: UserIcon,
    colors: { border: "#ede8fd", icon: "#ede8fd", iconText: "#534ab7", title: "#534ab7", itemBorder: "#ede8fd", itemHover: "#afa9ec", answerBorder: "#f5f0fe" },
    faqs: [
      {
  ...
  },
  {
    ...
    title: "Posts",
    icon: PencilIcon,
    colors: { border: "#fde8f0", icon: "#fde8f0", iconText: "#d4537e", title: "#d4537e", itemBorder: "#fde8f0", itemHover: "#ed93b1", answerBorder: "#fef0f5" },
    faqs: [
      {
  ...
  },
  {
    ...
    colors: { border: "#e8f0fd", icon: "#e8f0fd", iconText: "#185fa5", title: "#185fa5", itemBorder: "#e8f0fd", itemHover: "#85b7eb", answerBorder: "#f0f4fe" },
    faqs: [
      {
        q: "What is a chat?",
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-3 bg-white">
        <span className="text-sm font-semibold" style={{ color: '#2c2c2a' }}>{faq.q}</span>
        <svg
          className="w-4 h-4 flex-shrink-0 ml-3 transition-transform"
          style={{ color: '#b4b2a9', transform: open ? 'rotate(180deg)' : 'rotate(0deg)' }}
...
export default function HelpCenter() {
  return (
    <div className="min-h-screen bg-transparent px-6 py-8 mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-1" style={{ color: '#2c2c2a' }}>Help center</h1>
        <p className="text-sm" style={{ color: '#b4b2a9' }}>Find answers to the most common questions about Synk.</p>
      </div>
        ...
        return (
          <div key={section.key} className="mb-8">
            ...
            >
              ...
              <span className="text-sm font-semibold" style={{ color: c.title }}>{section.title}</span>
            </div>
