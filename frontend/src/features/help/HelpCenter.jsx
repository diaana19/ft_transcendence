        ...
        <div className="min-h-screen bg-transparent px-6 py-8 mx-auto">
            <div className="mb-8">
                ...
                <p className="text-sm leading-relaxed mb-3" style={{ color: '#5f5e5a' }}>
                    Welcome to the Synk Help Center. Here you'll find answers to the most common
                    questions about using the platform — from setting up your account and writing
                    your first post, to understanding how the friends system works and earning your
                    first badge.
                </p>
            </div>
